...
{
	cout << endl
		 << "Battle of the Three Armies - Day " << day << endl;
...
void PrintBattlefieldStats(int &day, Merchant &merchant, Faction &orcs, Faction &dwarves, Faction &elves)
{
	cout << endl
		 << "---------------------------------" << endl;
	;
	cout << "Battle of The Three Armies" << endl
		 << endl;
...
{
	cout << endl
		 << "Available weapon points for today: " << merchant.GetWeaponPoints() << endl;
	int choice;
	...
	while (!transactionSuccessful)
	{
		...
		case 2:
			...
			{
				cout << endl
					 << "----Selling weapons to Dwarves----" << endl;
...
{
	cout << endl
		 << "Available weapon points for today: " << merchant.GetArmorPoints() << endl;
	int choice;
	cout << "----CHOOSE FACTION TO SELL WEAPONS----" << endl;
	cout << "1-   Orcs" << endl;
	cout << "2-   Dwarves" << endl;
	...
	while (!transactionSuccessful)
	{
		...
		case 2:
			...
			{
				cout << endl
					 << "----Selling armors to Dwarves----" << endl;
...
int main()
{
	...
	do
	{
		...
		if (numOfFactionsAlive == 1)
		{
			...
			{
				cout << endl
					 << "----Orcs have won the war.----" << endl;
				orcs.Print();
			}
			else if (dwarves.IsAlive())
			{
				cout << endl
					 << "----Dwarves have won the war.----" << endl;
				dwarves.Print();
			}
			else if (elves.IsAlive())
			{
				cout << endl
					 << "----Elves have won the war.----" << endl;
				elves.Print();
			}
		}
		...
		cout << endl
			 << day << " days have passed." << endl;
		cout << merchant.GetRevenue() << " golds earned." << endl;

		if (playAgain && !gameContinue)
		{ // Check if player wants to play the game again
			int replay;
			cout << endl
				 << "If you want to play again, enter \"1\". Else, enter \"0\": ";
			cin >> replay;
